...
export default class WangStorageProxy {
  constructor (storage, {prefix = ''} = {}) {
    if (!this._isStorageObject(storage)) {
  ...
  // 判断是否为storage对象
  _isStorageObject(obj) {
    // instanceof判断Storage在node环境会报错
    return typeof obj === 'object' && obj !== null && typeof obj.setItem === 'function' && typeof obj.getItem === 'function';
  }
